...
const Latest = () => {
  ...
  const url = `https://api.github.com/search/repositories?q=user:${data.githubUsername}+sort:author-date-asc`;
  const getRepo = async () => {
  ...
  return (
    <Box>
      <Flex
        ...
        alignItems="center"
      >
        <Heading fontSize={"xxx-large"} className="select-none cursor-pointer">
          Latest Projects:
